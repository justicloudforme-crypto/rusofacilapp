 ...
 *
 * У тапа по слову без клипа **0** мест: 676 мест получили вырезку по
 * месту (46 в 7.168, 420 в 7.170, 210 в 7.174), а оставшиеся 7 органа
 * не рисуют вовсе — там вариант В печатает строку об ударении.
 */
const BASELINE: Record<string, [number, number]> = {
  ...
  "рассказы: тап по слову": [56635, 56635],
};
