...
export const PRICES = {
  "check:listen-buttons": {
    rows: 1_236_782,
    kind: "measured",
    what: "сплошная перепись органов «слушать» по боевой базе: 33 полных прохода по AudioAsset",
  },
  "check:frozen": {
    rows: 7_300_400,
    kind: "estimated",
    what: "330 URL живого сайта: 200 медиа-страниц по 36 328 строк и 130 рассказов по 260",
  },
  "check:reachability": {
    rows: 21_910_000,
    kind: "estimated",
    what: "обход всей карты сайта по ссылкам: 1913 URL, из них 552 медиа-страницы",
  },
};
