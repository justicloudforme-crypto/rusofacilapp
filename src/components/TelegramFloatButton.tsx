...
export default function TelegramFloatButton() {
  return (
    <a
      ...
      className="fixed bottom-[30px] right-[30px] z-[1000] flex h-[60px] w-[60px] items-center justify-center rounded-full bg-[#24A1DE] text-white shadow-[0_4px_10px_rgba(0,0,0,0.3)] transition-transform duration-200 ease-out hover:scale-110 hover:bg-[#2090c7]"
    >
