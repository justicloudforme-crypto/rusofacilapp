...
// Scoped error boundary for /{lang}/vocabulary — same pattern as
// profile/error.tsx: a data failure in this section previously took down
// the entire page with Next's default unstyled 500. Bilingual (no `lang`
// param is passed to error.tsx by Next) to match the two audiences this
// route serves.
  ...
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-md flex-col items-center justify-center gap-4 px-6 text-center">
      ...
      <p className="text-sm text-foreground/70">
        No pudimos cargar el vocabulario. Inténtalo de nuevo.
        <br />
        Не удалось загрузить словарь. Попробуйте ещё раз.
      </p>
