...
// Scoped error boundary for /{lang}/stories (and its [id] reader pages) —
  ...
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-md flex-col items-center justify-center gap-4 px-6 text-center">
      ...
      <p className="text-sm text-foreground/70">
        No pudimos cargar los relatos. Inténtalo de nuevo.
        <br />
        Не удалось загрузить рассказы. Попробуйте ещё раз.
      </p>
