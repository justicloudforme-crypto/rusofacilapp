# RusoFásil — сборка мобильного приложения (Capacitor)
...
задеплоенный/локальный сайт RusoFásil (не статический экспорт: сайт
...
Сейчас `com.rusofasil.app` — временный плейсхолдер. **Перед реальной
публикацией в App Store/Google Play замените его на reverse-domain,
который реально принадлежит вам** (например `com.вашдомен.rusofasil`) —
это часть идентификации приложения в сторах и не может быть изменено
после первой публикации без создания нового листинга.
